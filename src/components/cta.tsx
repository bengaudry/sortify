const style = "flex gap-3 bg-spotify-500 hover:bg-spotify-400 active:bg-spotify-600 rounded-full px-6 py-2 font-semibold text-spotify-900 hover:cursor-pointer transition-colors w-fit" + " ";
